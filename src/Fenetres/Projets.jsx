	...
	return (
		<div className="h-full flex flex-col">
			...
			{showFilterOverlay && (
				...
				>
					<div 
						className="bg-white rounded-2xl p-4 sm:p-6 max-w-2xl w-full max-h-[90vh] sm:max-h-[80vh] overflow-auto shadow-2xl"
						onClick={(e) => e.stopPropagation()}
					>
						<div className="flex justify-between items-center mb-4 sm:mb-6">
							<h2 className="text-xl sm:text-2xl font-bold">Filtrer les projets</h2>
							<button
								onClick={() => setShowFilterOverlay(false)}
						...
						<div className="mb-4 sm:mb-6">
							<h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">Technologies</h3>
					...
					{projetsFiltre.map((project, index) => (
						...
						>
							...
							<div className="flex justify-between items-center mb-2">
								<h2 className="text-lg sm:text-xl font-bold">{project.nom}</h2>
								<span className="text-xs sm:text-sm text-gray-600">{project.date.slice(0, 7).replace("-", "/")}</span>
							</div>
			...
			{/* Desktop: Split view */}
			<div className="hidden md:flex p-4 items-stretch flex-1 gap-4"></div>
            {/* Desktop: Split view */}
